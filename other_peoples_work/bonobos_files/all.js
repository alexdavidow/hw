/*1376855664,168634969,JIT Construction: v911604,en_US*/
          ...
          if (!m || !r) {
            ...
            if (!m) {
              ...
              k.stringify = function(ga, ha, ia) {
                ...
                if (g.call(ia) == "[object String]") ja = ia.length <= 10 ? ia : ia.slice(0, 10);
      ...
      var g = b('sdk.ErrorHandling'),
        ...
        k = {
          ...
          invokeHandler: function(l, m, n) {
            ...
            if (l.apply) g.unguard(l).apply(m, n || []);
          },
